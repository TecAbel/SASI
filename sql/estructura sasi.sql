...
create table clientes(
	cl_gc_cli char(7) not null unique,
...
create table equipos(
	eq_gc_equipo char(7) not null unique,
    ...
    eq_notas char(50) null
);

alter table equipos add column eq_sis_ope_lic char(30)  null; 

create table servicios(
	sr_gc_ser char(7) not null unique,
...
create table tecnicos(
	tc_gc_tec char(7) not null unique,
